...
@RestController
public class JavaAesGcmApiApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(JavaAesGcmApiApplication.class, args);
    }
     ...
     */
    private String encrypt(String plainText, String base64Key, Charset charset) throws Exception {
     ...
     */
    private String decrypt(String hexCipherText, String base64Key, Charset charset) throws Exception {
        SecretKey secretKey = getSecretKey(base64Key);
    ...
    @PostMapping("/encrypt")
    public ResponseEntity<String> encryptEndpoint(@RequestBody Map<String, String> payload) {
        try {
            ...
            String encryptedText = encrypt(plainText, key, charset);
    ...
    @PostMapping("/decrypt")
    public ResponseEntity<String> decryptEndpoint(@RequestBody Map<String, String> payload) {
        try {
            ...
            Charset charset = Charset.forName(charsetName);
            String decryptedText = decrypt(cipherText, key, charset);
